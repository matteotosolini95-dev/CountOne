...
export default function App() {
  ...
  async function handlePay() {
    ...
    try {
      ...
      await sendCertificateEmail(email.trim(), nick.trim(), newCount, certDate, isPrize);
      // Redirect to Stripe payment
      const stripeUrl = `https://buy.stripe.com/test_7sYaEQcjv7kJ39E7aIa7C00?prefilled_email=${encodeURIComponent(email.trim())}&client_reference_id=${newCount}`;
