...
const CONTINENT_BOX = {
  europe: { x: 460, y: 90, w: 110, h: 90 },
  northAmerica: { x: 130, y: 70, w: 200, h: 140 },
  southAmerica: { x: 270, y: 250, w: 110, h: 160 },
  asia: { x: 600, y: 80, w: 260, h: 170 },
  africa: { x: 470, y: 190, w: 130, h: 170 },
  oceania: { x: 800, y: 300, w: 120, h: 90 },
    ...
    <section style={mapStyles.section}>
      ...
      <div style={mapStyles.frame}>
        <svg viewBox="0 0 1000 500" style={mapStyles.svg} preserveAspectRatio="xMidYMid meet">
          {/* Very simplified continent silhouettes, stylized not geographically exact */}
          <g fill="#15151F" stroke="#262638" strokeWidth="1">
            <ellipse cx="230" cy="140" rx="115" ry="80" />
            <ellipse cx="330" cy="320" rx="65" ry="95" />
            <ellipse cx="510" cy="135" rx="65" ry="55" />
            <ellipse cx="535" cy="270" rx="75" ry="100" />
            <ellipse cx="730" cy="160" rx="135" ry="95" />
            <ellipse cx="860" cy="340" rx="65" ry="50" />
          </g>
          {dots.map((d) => (
            <circle key={d.key} cx={d.x} cy={d.y} r="4" fill="#F5A623" opacity="0.85">
  ...
  useEffect(() => {
    ...
    if (window.location.pathname === "/success" || params.get("payment") === "success") {
      ...
      if (savedNick && savedEmail) {
        ...
        setPaying(true);
        // Give the webhook a moment to land, then read the (already updated) count.
        setTimeout(() => {
          getCount().then((freshCount) => {
