...
const T = {
  it: {
    ...
    legalTerms: [
      ["1. Chi siamo", "CountOne è un progetto gestito da Matteo Tosolini, persona fisica privata, con sede in Italia. Per qualsiasi comunicazione: info@countone.org."],
      ...
      ["4. Premio periodico", "Ogni 100° partecipante riceve un buono Amazon da 15,00€. Il vincitore verrà contattato all'email fornita entro 30 giorni, senza bisogno di alcuna richiesta."],
    ...
    legalPrivacy: [
      ["1. Titolare del trattamento", "Matteo Tosolini, contattabile a info@countone.org."],
      ...
      ["3. Finalità", "I dati servono a generare e inviare il certificato, contattare l'eventuale vincitore, mantenere un registro interno per finalità organizzative e antifrode."],
      ...
      ["7. Diritti dell'utente", "Accesso, rettifica, cancellazione, limitazione, portabilità e opposizione al trattamento. Scrivi a info@countone.org per esercitarli."],
  ...
  en: {
    ...
    legalPrivacyTitle: "Privacy Policy",
    legalTerms: [
      ["1. Who we are", "CountOne is a project run by Matteo Tosolini, a private individual based in Italy. Contact: info@countone.org."],
      ...
      ["4. Periodic prize", "Every 100th participant receives a €15.00 Amazon voucher. The winner is contacted at the provided email within 30 days, no request needed."],
    ...
    legalPrivacy: [
      ["1. Data controller", "Matteo Tosolini, reachable at info@countone.org."],
      ...
      ["3. Purpose", "Data is used to generate and send the certificate, contact any prize winner, and maintain an internal record for organizational and anti-fraud purposes."],
      ...
      ["7. User rights", "Access, rectification, deletion, restriction, portability, and objection. Write to info@countone.org to exercise them."],
        ...
        setTimeout(() => {
          getCount().then((freshCount) => {
            ...
            setCert({
              ...
              email: savedEmail,
              date: certDate,
              prize: null, // unknown client-side on purpose; the email already says it
            });
            setPhase("cert");
            setPaying(false);
